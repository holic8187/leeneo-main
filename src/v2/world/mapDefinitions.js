...
const MAP_DEFINITIONS = [
  ...
  { id: 'audit_archive', name: '감사자료 심층서고', region: '재무회계동', minLevel: 44, maxLevel: 62, theme: 'archive', features: ['ladder', 'boxes'] },

  { id: 'brand_studio', name: '브랜드 스튜디오', region: '영업마케팅동', minLevel: 30, maxLevel: 48, theme: 'studio', features: ['rope'] },
  { id: 'ad_set', name: '심야 광고촬영장', region: '영업마케팅동', minLevel: 36, maxLevel: 54, theme: 'studio', features: ['ladder'] },
  ...
  { id: 'dev_floor', name: '개발실 오픈플로어', region: '개발연구동', minLevel: 50, maxLevel: 70, theme: 'development', features: ['ladder'] },
  { id: 'server_corridor', name: '서버랙 냉각통로', region: '개발연구동', minLevel: 56, maxLevel: 76, theme: 'server', features: ['rope'] },
  ...
  { id: 'data_center', name: '심층 데이터센터', region: '개발연구동', minLevel: 82, maxLevel: 108, theme: 'server', features: ['ladder'] },
  ...
  { id: 'quality_lab', name: '품질검사 통제동', region: '생산관리동', minLevel: 92, maxLevel: 118, theme: 'quality', features: ['elevator'] },
...
const MAP_EDGES = [
  ...
  ['finance_analysis', 'audit_archive', '심층서고 문'],
  ['finance_analysis', 'sales_floor', '실적보고 통로'],
  ['audit_archive', 'executive_strategy', '임원전용 승강기'],
  ...
  ['sales_floor', 'executive_strategy', '실적보고 승강기'],
  ...
  ['data_center', 'overtime_depths', '심야 접속구'],
  ['production_line', 'facility_engine', '생산설비 통로'],
  ['production_line', 'quality_lab', '검수 라인'],
  ['facility_engine', 'logistics_warehouse', '화물 승강기'],
