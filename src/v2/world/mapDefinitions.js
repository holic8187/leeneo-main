...
const MAP_LAYOUT_PRESETS = Object.freeze({
  ...
  tiny: Object.freeze({
    ...
    spawnPerWave: 5,
    platforms: Object.freeze([
      Object.freeze({ id: 'ground', floor: 0, x: 0, width: 100, bottom: 42, spawnEnabled: true, spawnSlots: 7 }),
      Object.freeze({ id: 'jump-ledge', floor: 1, x: 37, width: 28, bottom: 172, spawnEnabled: true, spawnSlots: 3 })
    ]),
    connectors: Object.freeze([
  ...
  compact: Object.freeze({
    ...
    spawnPerWave: 6,
    platforms: Object.freeze([
      Object.freeze({ id: 'ground-left', floor: 0, x: 0, width: 46, bottom: 42, spawnEnabled: true, spawnSlots: 5 }),
      Object.freeze({ id: 'ground-right', floor: 0, x: 54, width: 46, bottom: 42, spawnEnabled: true, spawnSlots: 5 }),
      Object.freeze({ id: 'jump-deck', floor: 1, x: 18, width: 26, bottom: 178, spawnEnabled: true, spawnSlots: 3 }),
      Object.freeze({ id: 'quiet-deck', floor: 1, x: 60, width: 25, bottom: 178, spawnEnabled: false, spawnSlots: 0 }),
      Object.freeze({ id: 'ladder-deck', floor: 2, x: 48, width: 27, bottom: 322, spawnEnabled: true, spawnSlots: 3 })
    ]),
    connectors: Object.freeze([
  ...
  wide: Object.freeze({
    ...
    spawnPerWave: 7,
    platforms: Object.freeze([
      Object.freeze({ id: 'ground', floor: 0, x: 0, width: 100, bottom: 42, spawnEnabled: true, spawnSlots: 9 }),
      Object.freeze({ id: 'west-deck', floor: 1, x: 8, width: 28, bottom: 184, spawnEnabled: true, spawnSlots: 5 }),
      Object.freeze({ id: 'center-rest', floor: 1, x: 42, width: 16, bottom: 184, spawnEnabled: false, spawnSlots: 0 }),
      Object.freeze({ id: 'east-deck', floor: 1, x: 65, width: 28, bottom: 184, spawnEnabled: true, spawnSlots: 5 }),
      Object.freeze({ id: 'high-deck', floor: 2, x: 34, width: 32, bottom: 342, spawnEnabled: true, spawnSlots: 5 })
    ]),
    connectors: Object.freeze([
  ...
  tower: Object.freeze({
    ...
    platforms: Object.freeze([
      Object.freeze({ id: 'ground', floor: 0, x: 0, width: 100, bottom: 42, spawnEnabled: true, spawnSlots: 7 }),
      Object.freeze({ id: 'first-left', floor: 1, x: 6, width: 37, bottom: 190, spawnEnabled: true, spawnSlots: 5 }),
      Object.freeze({ id: 'first-right', floor: 1, x: 55, width: 38, bottom: 190, spawnEnabled: true, spawnSlots: 5 }),
      Object.freeze({ id: 'second-left', floor: 2, x: 18, width: 30, bottom: 354, spawnEnabled: false, spawnSlots: 0 }),
      Object.freeze({ id: 'second-right', floor: 2, x: 60, width: 31, bottom: 354, spawnEnabled: true, spawnSlots: 5 }),
      Object.freeze({ id: 'summit', floor: 3, x: 34, width: 34, bottom: 524, spawnEnabled: true, spawnSlots: 5 })
    ]),
    connectors: Object.freeze([
  ...
  sprawling: Object.freeze({
    ...
    spawnPerWave: 9,
    platforms: Object.freeze([
      Object.freeze({ id: 'ground-west', floor: 0, x: 0, width: 31, bottom: 42, spawnEnabled: true, spawnSlots: 6 }),
      Object.freeze({ id: 'ground-center', floor: 0, x: 35, width: 29, bottom: 42, spawnEnabled: true, spawnSlots: 6 }),
      Object.freeze({ id: 'ground-east', floor: 0, x: 68, width: 32, bottom: 42, spawnEnabled: true, spawnSlots: 6 }),
      Object.freeze({ id: 'lower-west', floor: 1, x: 6, width: 23, bottom: 190, spawnEnabled: true, spawnSlots: 5 }),
      Object.freeze({ id: 'lower-center', floor: 1, x: 38, width: 24, bottom: 190, spawnEnabled: false, spawnSlots: 0 }),
      Object.freeze({ id: 'lower-east', floor: 1, x: 72, width: 22, bottom: 190, spawnEnabled: true, spawnSlots: 5 }),
      Object.freeze({ id: 'upper-west', floor: 2, x: 18, width: 25, bottom: 358, spawnEnabled: true, spawnSlots: 3 }),
      Object.freeze({ id: 'upper-east', floor: 2, x: 58, width: 27, bottom: 358, spawnEnabled: true, spawnSlots: 3 })
    ]),
    connectors: Object.freeze([
...
function buildMapLayout(map, index = 0) {
  ...
  const widthOffset = map.safeZone || map.fieldBossId ? 0 : (seed % 3 - 1) * 80;
