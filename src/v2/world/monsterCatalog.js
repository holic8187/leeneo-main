...
const THROWING_STAR_DROP_GROUPS = Object.freeze({
  ...
  executive_approval_star: Object.freeze({
    name: '임원 결재 표창', icon: '✴️', quantity: 600, chance: 1 / 12,
    monsterIds: Object.freeze([
