...
const { LATE_SUMMER_EVENT_ITEMS } = require('./lateSummerEventCatalog');
...
const BASE_ITEMS = {
  ...
  gyeo_manager_blood: {
    id: 'gyeo_manager_blood',
    name: '겨부장의 피',
    category: 'cash',
    itemType: 'death-exp-protection',
    icon: '🩸',
    maxStack: 10,
    sellPrice: 0,
    tradeable: false,
    marketable: false,
    description: '지니고 있으면 캐릭터 사망 시 경험치 감소를 1회 막아주고 1개가 자동으로 사라집니다. 직접 사용할 수 없습니다.',
    adminGrantOnly: true
  },
...
for (const eventItem of LATE_SUMMER_EVENT_ITEMS) {
  BASE_ITEMS[eventItem.id] = { ...eventItem };
}
